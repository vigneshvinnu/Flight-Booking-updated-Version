      ...
      <div className="col-md-12">
        <div className="card card-container" style={{"backgroundColor":"lightblue"}}>
          ...
          >
            {!this.state.successful && (
              <div>
                <div className="form-group">
                  <label htmlFor="username" class="fa fa-user"> Username</label>
                  <Input
                    type="text"
                ...
                <div className="form-group">
                  <label htmlFor="email" class="fa fa-envelope"> Email</label>
                  <Input
                    type="text"
                    className="form-control"
                    name="email"
            ...
            <p>Already have an account! <a href="/login" style={{"color":"tomato"}}>Login here</a></p>
            </div>
          </Form>
        </div>
      </div>
